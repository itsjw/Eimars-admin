...
const headers = ['#', 'USER NAME', 'EMAIL', 'CONTACT NO' ,'Joining Date', 'Status'];
const content = [
  ['1', 'UID', 'Mark', '10/10/2014', <span className="label label-danger">in progress</span>, <span className="badge badge-info">50%</span>],
